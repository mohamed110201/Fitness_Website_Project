...
<section id="home" class="home view">
    <div class="high">
        <h3>Welcome <b><?php echo $_SESSION['user'];?></b></h3>
        <br><br>
        <h1><b>P-P-L Split</b> Program</h1><br>
...
<section id="program" class="workout view">
    ...
    <div class="content">
        <div class="frame">
            <div class="box">
                <img src="images/push.jpg" alt="Chest workout">
            </div>
            <div class="title">Push Workouts</div>
            <a href="push.html">Join</a>
        </div>
        <div class="frame">
            <div class="box">
                <img src="images/pull.jpg" alt="Back workout">
            </div>
            <div class="title">Pull workouts</div>
            <a href="pull.html" onclick=";">Join</a>
        </div>
        <div class="frame">
            <div class="box">
                <img src="images/leg.jpg" alt="Shoulder workout">
            </div>
            <div class="title">Legs workouts</div>
            <a href="legppl.html">Join</a>
        </div>
   ...
   <div class="tableee">
    ...
    <table>
        ...
        <tr>
            ...
            <td><button class="download"><a href="wordfiles/p-p-l.pdf" >Download</a></button></td>
        </tr>
