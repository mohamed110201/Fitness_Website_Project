...
<section id="home" class="home view">
    <div class="high">
    <h3>Welcome <b><?php echo $_SESSION['userr'];?></b></h3>
    <br><br>
        <h1><b>U-L</b> Program</h1><br>
    </div>
...
<section id="program" class="workout view">
    ...
    <div class="content">
        <div class="frame">
            <div class="box">
                <img src="images/upper.jpg" alt="Chest workout">
            </div>
            <div class="title">Upper Workouts</div>
            <a href="upper.html">Join</a>
        </div>
        <div class="frame">
            <div class="box">
                <img src="images/lower.jpg" alt="Back workout">
            </div>
            <div class="title">Lower workouts</div>
            <a href="lower.html" onclick=";">Join</a>
        </div>
   ...
   <div class="tableee">
    ...
    <table>
        ...
        <tr>
            ...
            <td><button class="download"><a href="wordfiles/U-L.pdf" >Download</a></button></td>
        </tr>
